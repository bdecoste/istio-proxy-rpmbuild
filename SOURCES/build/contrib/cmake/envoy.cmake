...
#set_target_properties(envoy PROPERTIES LINK_FLAGS "-Wl,--unresolved-symbols=ignore-all")
...
target_include_directories(envoy PUBLIC
        ...
        ${ISTIO_DEP_GENFILES}/external/envoy/include
#        ${ISTIO_DEP_GENFILES}/external/com_github_gabime_spdlog/include
        ${ISTIO_DEP_GENFILES}/external/com_github_cyan4973_xxhash
...
target_link_libraries(envoy PUBLIC googleapis)
...
target_link_libraries(envoy PUBLIC dl)
